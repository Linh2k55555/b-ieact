    ...
    <div className="checkout-container">
      ...
      <div className="container">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div>
            <label><input type="radio" name="paymentMethod" value="cod" checked={formData.paymentMethod === 'cod'} onChange={handleInputChange} required /> Thanh toán khi nhận hàng</label>
            <label><input type="radio" name="paymentMethod" value="transfer" checked={formData.paymentMethod === 'transfer'} onChange={handleInputChange} /> Chuyển khoản</label>
          </div>
